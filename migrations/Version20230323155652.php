 ...
 */
final class Version20230323155652 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles JSON NOT NULL, ADD password VARCHAR(255) NOT NULL, ADD mail VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(180) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP roles, DROP password, DROP mail, CHANGE email email VARCHAR(255) NOT NULL');
    }
}
